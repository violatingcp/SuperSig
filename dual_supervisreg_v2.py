...
class DualScaleVisRegLoss(nn.Module):
    """
    Dual-scale VisReg loss with FIXED projection slices.
...
        # --- Create and Register Fixed Projections ---
        # W shape is (embed_dim, num_projections)
        # Using register_buffer ensures these matrices move automatically to GPU/CPU with
        # the module and are saved in state_dict checkpoints without being tracking as trainable gradients.
...
        # Replaced torch.randn with the pre-compiled, registered buffer
