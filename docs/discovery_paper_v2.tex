...
objective clears the gate on \emph{both} backbones: supervised distance-NPLM
clears $5/5$ draws on LeJEPA and $0/5$ on DINO. SupCon+SIGReg clears $5/5$ on
both. Base-independence is a stronger and more useful property than winning on
